...
UI(3).Control = {'User B6','Style','VsToggleButton','Label','Save 1 sec'};
UI(3).Callback = text2cell('%SaveSecCallback');
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
if UIState == 1
    P.SaveSecFlag = 1;
    fprintf("START Saving every 1 sec\n");
else
    P.saveImageFlag = 0;
    fprintf("STOP Saving every 1 sec\n");
end
assignin('base','P',P);
return
%SaveSecCallback
